...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    Exercise.create(activity: "Side Lateral Raise", muscle_group: "Delts", image:"https://media.giphy.com/media/CdVoi9ZRijuxnawKeE/giphy.gif?cid=790b76119b3a0c4dc6e3d87b4a6ce1e9bc8df54a3433576d&rid=giphy.gif&ct=g")
