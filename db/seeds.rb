...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    Exercise.create(activity: "Side Lateral Raise", muscle_group: "Delts", image:"https://giphy.com/gifs/dance-sport-fitness-RUqTTOgWdIbHW")
    ...
    Exercise.create(activity: "Shoulder Press", muscle_group: "Delts", image:"https://giphy.com/gifs/pumping-iron-xIcHeirtPlp15mPtyY")
    Exercise.create(activity: "Jump Rope", muscle_group: "Cardio", image:"https://i.gifer.com/Avs1.gif")
