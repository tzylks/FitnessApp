...
function Dashboard({ currentUser }) {
    ...
    return (
        <>
            ...
            <Parallax y={[-360, 100]} x={[100, 120]} tagOuter="figure">
                <motion.div
                    style={{
                        zIndex: "1",
                        borderRadius: "70%",
                    ...
                    animate={{ x: [0, 100, 100, -100, 0], y: [0, -900, 0, 100], rotate: 1000 }}
                    transition={{ duration: 10, loop: Infinity, ease: "linear" }} />
            </Parallax>

       
            <Parallax y={[-460, 100]}tagOuter="figure">
                <motion.div
                    // style={{
                    //     zIndex: "1",
                    //     borderRadius: "70%",
                    ...
                    // }}
                    className="balloon"
                    style={{marginLeft: '80vw', transform: "rotate(45deg)"}}

                    animate={{ x: [0, 100, 100, -100, 0], y: [0, -1400, 0, 100], rotate: 1000 }}
                    transition={{ duration: 10, loop: Infinity, ease: "linear" }} />
            </Parallax>
